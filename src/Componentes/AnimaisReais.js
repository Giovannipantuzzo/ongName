export const animaisReais = [
  {
    ...
    comentarios: [
      ...
      },
      {
        ...
        texto: "Sansão é bem arisco, nao gosta de contato",
      },
      {
        nome: "Gabriel Dias",
  ...
  },
  {
    ...
    comentarios: [
      ...
      },
      {
        ...
        texto: "Bebe bastante liquido e ama biscoito de polvilho",
      },
      {
        nome: "Bruno Campos",
        foto: "/images/Colaboradores/BrunoCampos.jpg",
        texto: "Anda miando para as portas, além de arranhar tudo que pode",
      },
    ],
  },
  {
    ...
    comentarios: [
      ...
      },
      {
        ...
        texto: "Não gosta nem um pouco que ficar preso, só quer sair",
      },
      {
        nome: "Gabriel Dias",
        foto: "/images/Colaboradores/GabrielDias.jpg",
        texto: "Odeia a ideia de se molhar, corre de tudo que envolve água",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Giovanna Souza",
        foto: "/images/Colaboradores/GiovannaSouza.png",
        texto: "Merece muito amor, já foi maltratado na vida",
      },
      {
        nome: "Gabriel Dias",
        foto: "/images/Colaboradores/GabrielDias.jpg",
        texto: "Muito bonzinho e possue alguns problemas de saúde",
      },
      {
        nome: "Arthur Lima",
        foto: "/images/Colaboradores/ArthurLima.jpg",
        texto: "Espero que encontre alguem que dê o carrinho que ele merece <3",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Bruno Campos",
        foto: "/images/Colaboradores/BrunoCampos.jpg",
        texto: "Pequena, porém muito brava, não da paz para os pets maiores",
      },
      {
        nome: "Ana Gonçalves",
        foto: "/images/Colaboradores/AnaGoncalves.png",
        texto:
          "Gosta muito de dormir e brinquedos, mas também adora quebrar eles",
      },
      {
        nome: "Helio Neto",
        foto: "/images/Colaboradores/HelioNeto.jpg",
        texto: "Nossa ela adora pessoas, sorri muito quando brincam com ela",
      },
    ],
  },
  {
    ...
    comentarios: [
      ...
      },
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
        texto: "Brinca, brica e brinca.... só pode ser ligado no 220",
      },
      {
        nome: "Ian Xavier",
  ...
  },
  {
    ...
    sexo: "Macho",
    descricao:
      "Esse é o X. Foi resgatado por mim durante uma corrida na orla da lagoa da Pampulha. Me seguiu por uns 3 metros e foi o suficiente. Chuto que na época ele tinha uns 3 meses. Ficou doente e foi salvo por um veterinário mais mediante à verba que eu tinha para comprar cerveja pelo resto do mês. Está comigo desde novembro de 2020, tem como alimentação básica a ração misturada com um patêzinho pra dar uma norteada, e ganha uns tiragosto de sachê, ovo de codorna cru e uns belisquete de carne crua. Quando chegou tinha 600g, hj tem uns 4kg. Ainda não está castrado, pois a cirurgia ainda não coube no orçamento (professor é falido, estudante é falido ao quadrado, então estudante q é professor é falido ao cubo). Mas garanto que tem uma vida mais digna do que teria na orla da lagoa. Parceria construída na pandemia.",
    Raca: "Vira-lata",
    comentarios: [
      {
        nome: "Gabriel Dias",
        foto: "/images/Colaboradores/Gabriel Dias",
      ...
      {
        nome: "Igor Amoras",
        foto: "/images/Colaboradores/IgorAmoras.jpg",
        texto: "Carambaaaa.... deu uma pela encorpada hahaha",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Helio Neto",
        foto: "/images/Colaboradores/HelioNeto.jpg",
        texto: "Não para nunca, corre corre e corre.... Gzussss, nada aguenta",
      },
      {
        nome: "Arthur Lima",
        foto: "/images/Colaboradores/ArthurLima.jpg",
        texto: "Ele ama brincar com gato, nunca vi igual",
      },
      {
        nome: "Gabriel Dias",
        foto: "/images/Colaboradores/GabrielDias.jpg",
        texto: "Uma fofuraaaa, precisam ver só como ele é um amorzinho",
      },
    ],
  },
  {
    ...
    comentarios: [
      ...
      },
      {
        nome: "Ian Xavier",
        foto: "/images/Colaboradores/IanXavier.png",
        texto: "Adora que brinquem com ele",
      },
      {
        nome: "Marcone Faria",
        foto: "/images/Colaboradores/MarconeFaria.png",
        texto: "Nossa... ele ve um lugar que não cabe e pula la dentro",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Ana Gonçalves",
        foto: "/images/Colaboradores/AnaGoncalves.png",
        texto: "Corre, pula, rola e não para um minuto",
      },
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
        texto: "É ver uma pessoa que ela arruma uma latição e não para mais",
      },
      {
        nome: "Arthur Lima",
        foto: "/images/Colaboradores/ArthurLima.jpg",
        texto: "Os carteiros passam aperado, mas adoram ela",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Giovanni Pantuzzo",
        foto: "/images/Colaboradores/GiovanniPantuzzo.jpg",
        texto: "Ele é tão lindinho, merece amor demais",
      },
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
      ...
      },
      {
        nome: "Ana Gonçalves",
        foto: "/images/Colaboradores/AnaGoncalves.png",
        texto: "Ele é super animado e adora brincar sempre que pode",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Igor Amoras",
        foto: "/images/Colaboradores/IgorAmoras.jpg",
        texto: "Nuuuuu...pensa numa pet nervosa, é a Meg",
      },
      {
        nome: "Gabriel Dias",
        foto: "/images/Colaboradores/GabrielDias.jpg",
        texto: "Tem bastante medo de chuva, mas do resto nem pisca",
      },
      {
        nome: "Tainan Albuquerque",
        foto: "/images/Colaboradores/TainanAlbuquerque.jpg",
        texto: "Super carinhosaaaaa, Fofa demais e muito meiga",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Ana Gonçalves",
        foto: "/images/Colaboradores/AnaGoncalves.png",
        texto: "Pantera sobe em tudoooooooo, nem o céu é o limite",
      },
      {
        nome: "Giovanna Souza",
        foto: "/images/Colaboradores/GiovannaSouza.png",
        texto: "Arteira demais, tá em todo lugar que não pode",
      },
      {
        nome: "Helio Neto",
        foto: "/images/Colaboradores/HelioNeto.jpg",
        texto: "Muito carinhosa, espero que encontre um lar bom",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Pedro Barros",
        foto: "/images/Colaboradores/PedroBarros.png",
        texto: "Juju vive pulando de lado em ladoooo",
      },
      {
        nome: "Arthur Lima",
        foto: "/images/Colaboradores/ArthurLima.jpg",
        texto: "Brinca o dia todo se deixar",
      },
      {
        nome: "Matheus Franklin",
        foto: "/images/Colaboradores/MatheusFranklin.jpg",
        texto: "Sai da frente que ela vem quente... não para",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Pedro Barros",
        foto: "/images/Colaboradores/PedroBarros.png",
        texto: "Bem devagar, curte a tranqulidade e paz do ambiente",
      },
      {
        nome: "Tainan Albuquerque",
        foto: "/images/Colaboradores/TainanAlbuquerque.jpg",
        texto: "Se deixar dorme o dia todoooooo",
      },
      {
        nome: "Arthur Lima",
        foto: "/images/Colaboradores/ArthurLima.jpg",
        texto: "Nunca vi tanta preguiça junto",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Gabriel Dias",
        foto: "/images/Colaboradores/GabrielDias.jpg",
        texto: "Tem sua melhor amiga uma cachorrinha",
      },
      {
        nome: "Helio Neto",
        foto: "/images/Colaboradores/HelioNeto.jpg",
        texto: "Adoraaaaaa dar e receber carinho",
      },
      {
        nome: "Ana Gonçalves",
        foto: "/images/Colaboradores/AnaGoncalves.png",
        texto: "Tem umas mãoszinha minusculas, é uma graçaaaaaaaa",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
        texto: "Ela adora colo e é super ciumenta",
      },
      {
        nome: "Giovanna Souza",
        foto: "/images/Colaboradores/GiovannaSouza.png",
        texto: "Brinca, brinca e brinca, ritmo acelerado",
      },
      {
        nome: "Bruno Campos",
        foto: "/images/Colaboradores/BrunoCampos.jpg",
        texto: "Adoraaaaa correr no quintal, espaço aberto e em qualquer lugar",
      },
    ],
  },
  {
    ...
    comentarios: [
      ...
      },
      {
        nome: "Matheus Franklin",
        foto: "/images/Colaboradores/MatheusFranklin.jpg",
        texto: "Ele é super agitado, tímido no inicio, mas depois se solta",
      },
      {
        nome: "Igor Amoras",
        foto: "/images/Colaboradores/IgorAmoras.jpg",
        texto: "Bem espertinho e ligeiro, atenção é tudo para ele",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        ...
        foto: "/images/Colaboradores/MarconeFaria.png",
        texto:
          "Ama passear, quase pega a coleira sozinho para que leve ele kkk",
      },
      {
        nome: "Ana Gonçalves",
        foto: "/images/Colaboradores/AnaGoncalves.png",
        texto: "Adora brincar com bolinha de borracha e com outros pets",
      },

      {
        nome: "Gabriel Dias",
        foto: "/images/Colaboradores/GabrielDias.jpg",
        texto: "Aii um amor de pet, merece muito carinho",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Marcone Faria",
        foto: "/images/Colaboradores/MarconeFaria.png",
        texto: "As duas são muito fofas, perfeitas só isso",
      },
      {
        nome: "Matheus Franklin",
        foto: "/images/Colaboradores/MatheusFranklin.jpg",
        texto: "Duas graças, sempre juntas e bricando o tempo todo",
      },
      {
        nome: "Tainan Albuquerque",
        foto: "/images/Colaboradores/TainanAlbuquerque.jpg",
        texto: "Elas são muito unidas e amigas, fazem tudo juntas sempre",
      },
    ],
  },
  {
    ...
    sexo: "Fêmea",
    descricao:
      "Melzinha é sempre foi muito mau humorada e bravinha! Sempre latiu muito e isso não mudou depois de velhinha. Ama comer de tudo, principalmente pão de sal. Gosta dos seus irmãozinhos, mas é impaciente com eles, já que eles são crianças ainda.",
    Raca: "Poodle",
    comentarios: [
      {
        nome: "Ana Gonçalves",
      ...
      },
      {
        nome: "Igor Amoras",
        foto: "/images/Colaboradores/IgorAmoras.jpg",
        texto: "Uma gracinha, mas late com todo mundo",
      },
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
    ...
    comentarios: [
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
        texto: "Nossaaaa é um amor de pet, quero que tenha um lar adorável",
      },
      {
        nome: "Giovanna Souza",
        foto: "/images/Colaboradores/GiovannaSouza.png",
        texto: "Aiii um fofuxo, gordinho gostoso haha",
      },
      {
        nome: "Pedro Barros",
        foto: "/images/Colaboradores/PedroBarros.png",
        texto: "Aiii vontade de pegar para mim e viver apraçadinho",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
        texto: "Nossa nunca vi um cachorro tão possessivo na vidaaaa",
      },
      {
        nome: "Marcone Faria",
        foto: "/images/Colaboradores/MarconeFaria.png",
    ...
    comentarios: [
      {
        nome: "Arthur Lima",
        foto: "/images/Colaboradores/ArthurLima.jpg",
        texto: "Não gosta que ninguem chegue na casa, nem os donos kkkkk",
      },
      {
        nome: "Helio Neto",
        foto: "/images/Colaboradores/HelioNeto.jpg",
        texto: "Nossa faz uma cena que nenhum ator conseguiria fazer igual",
      },
      {
        nome: "Giovanna Souza",
        foto: "/images/Colaboradores/GiovannaSouza.png",
        texto: "Ele gosta de ficar em paz e adora uns presentinhos",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Tainan Albuquerque",
        foto: "/images/Colaboradores/TainanAlbuquerque.jpg",
        texto: "Nossaaaaa...nervosinha, treme igual vara verde de raiva",
      },
      {
        nome: "Igor Amoras",
        foto: "/images/Colaboradores/IgorAmoras.jpg",
      ...
      },
      {
        nome: "Giovanni Pantuzzo",
        foto: "/images/Colaboradores/GiovanniPantuzzo.jpg",
        texto: "Se ver você abrindo o portão correndo pra rua, nunca vi igual",
      },
    ],
  },
  {
    ...
    comentarios: [
      ...
      },
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
        texto: "Ama a familia, mas odeia pessoas de fora, nem gosta de visita",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Bruno Campos",
        foto: "/images/Colaboradores/BrunoCampos.jpg",
        texto: "Gosta demais de brincar com seus animais de borracha",
      },
      {
        nome: "Ana Gonçalves",
        foto: "/images/Colaboradores/AnaGoncalves.png",
    ...
    comentarios: [
      {
        nome: "Igor Amoras",
        foto: "/images/Colaboradores/IgorAmoras.jpg",
        texto: "Teddy é muito brincalhão e vive dormindo",
      },
      {
        nome: "Gabriel Dias",
        foto: "/images/Colaboradores/GabrielDias.jpg",
        texto: "Uma graça o Teddy, fofinho demais ele",
      },
      {
        nome: "Arthur Lima",
        foto: "/images/Colaboradores/ArthurLima.jpg",
        texto: "Ele é muito lindo quero para mim",
      },
    ],
  },
  {
    ...
    comentarios: [
      ...
      },
      {
        ...
        foto: "/images/Colaboradores/HelioNeto.jpg",
        texto:
          "Ela é meio agressiva as vezes, mas só até fazer um carinho nela",
      },
      {
        nome: "Ian Xavier",
        foto: "/images/Colaboradores/IanXavier.png",
    ...
    comentarios: [
      {
        ...
        foto: "/images/Colaboradores/PedroBarros.png",
        texto:
          "Não gosta de sair de casa de jeito nenhum, fica so no cantinho dela",
      },
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
        texto: "Ama aquele carinho na barriga, nunca vi igual",
      },
      {
        nome: "Ana Gonçalves",
        foto: "/images/Colaboradores/AnaGoncalves.png",
        texto: "Bem quieto e não curte sair, gosta de dar e receber carinho",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Arthur Lima",
        foto: "/images/Colaboradores/ArthurLima.jpg",
        texto: "Vive em baixo das cobertas e dificil ver ela longe delas",
      },
      {
        nome: "Tainan Albuquerque",
        foto: "/images/Colaboradores/TainanAlbuquerque.jpg",
        texto: "Super carinho, tanto para dar quanto para receber",
      },
      {
        nome: "Helio Neto",
        foto: "/images/Colaboradores/HelioNeto.jpg",
        texto: "Ela ama se esconder em locais altos e de dificil acesso",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Giovanna Souza",
        foto: "/images/Colaboradores/GiovannaSouza.png",
        texto: "Bob nem para quieto, corre o tempo todo",
      },
      {
        nome: "Marcone Faria",
        foto: "/images/Colaboradores/MarconeFaria.png",
        texto: "Super amigo, ele merece muito um lar que seja acolhedor",
      },
      {
        nome: "Arthur Lima",
        foto: "/images/Colaboradores/ArthurLima.jpg",
        texto: "Ahhh ele é demais, corre e brinca com todos, adora companhia",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    comentarios: [
      ...
      },
      {
        nome: "Matheus Franklin",
        foto: "/images/Colaboradores/MatheusFranklin.jpg",
        texto: "Muito amigavel e corre atras de tudo que passa voando",
      },
      {
        nome: "Tainan Albuquerque",
        foto: "/images/Colaboradores/TainanAlbuquerque.jpg",
        texto: "Incrivelmente eletrico, não para um minuto sequer",
      },
    ],
  },
  {
    ...
    comentarios: [
      ...
      },
      {
        nome: "Igor Amoras",
        foto: "/images/Colaboradores/IgorAmoras.jpg",
        texto: "Tira cada cochilo que fico de cara como consegue ser assim",
      },
      {
        nome: "Helio Neto",
        foto: "/images/Colaboradores/HelioNeto.jpg",
    ...
    comentarios: [
      {
        ...
        foto: "/images/Colaboradores/IanXavier.png",
        texto:
          "Ele é bem ciumento, não gosta que cheguem perto quando ta recebendo o carinho dela",
      },
      {
        nome: "Pedro Barros",
        foto: "/images/Colaboradores/PedroBarros.png",
        texto: "Pula em tudo que pode, parece um canguru kkkk",
      },
      {
        nome: "Matheus Franklin",
        foto: "/images/Colaboradores/MatheusFranklin.jpg",
        texto: "Ama um colinho, fica igual um nenem, todo dengoso",
      },
    ],
  },
  {
    ...
    sexo: "Fêmea",
    descricao:
      "É a dona da casa. Ela é muito anti-social, não gostou nem um pouquinho dos filhotes quando eles chegaram, odeia ser pega no colo, odeia crianças, mas adora um carinho na cabeça e passa o dia inteiro na varanda ou dando role nos muros",
    Raca: "Vira-lata",
    comentarios: [
      {
        nome: "Matheus Franklin",
    ...
    comentarios: [
      {
        nome: "Pedro Barros",
        foto: "/images/Colaboradores/PedroBarros.png",
        texto: "Dono meio bravo, tomem cuitado",
      },
      {
        nome: "Ian Xavier",
        foto: "/images/Colaboradores/IanXavier.png",
        texto: "Esse ai não quer ninguem atrás do pet dele",
      },
      {
        nome: "Helio Neto",
        foto: "/images/Colaboradores/HelioNeto.jpg",
        texto: "Gente procura outro pet pra adotar, esse ai vai dar BO kkk",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Gabriel Mauad",
        foto: "/images/Colaboradores/GabrielMauad.jpg",
        texto: "Linguinha frenetica na orelha dos outros",
      },
      {
        nome: "Marcone Faria",
        foto: "/images/Colaboradores/MarconeFaria.png",
      ...
      },
      {
        nome: "Ana Gonçalves",
        foto: "/images/Colaboradores/AnaGoncalves.png",
        texto: "Muito agitada e não para quieta, tentada demais",
      },
    ],
  },
  {
    ...
    comentarios: [
      {
        nome: "Giovanna Souza",
        foto: "/images/Colaboradores/GiovannaSouza.png",
        texto: "Nossa.... so come e anda, faz tudo junto se deixar",
      },
      {
        nome: "Gabriel Dias",
        foto: "/images/Colaboradores/GabrielDias.jpg",
        texto:
          "Não tem tempo ruim para ela, pode levantar pra passear qualquer hora",
      },
      {
        nome: "Tainan Albuquerque",
        foto: "/images/Colaboradores/TainanAlbuquerque.jpg",
